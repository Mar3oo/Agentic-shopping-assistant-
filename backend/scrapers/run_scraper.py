...
# from backend.database.db import close_client
from backend.database.ingestion import ingest_records
from backend.scrapers import amazon, jumia, noon
from backend.scrapers.base import build_records, create_brave_driver
